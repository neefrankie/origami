...
const defaultSocialNames = ['wechat', 'weibo', 'linkedin', 'facebook', 'twitter'];
...
function generateHtml ({links=defaultSocialNames, outDir='views/partials'} = {})  {
  output = path.resolve(__, `${destDir}/o-share.html`);
