class Search {
  constructor(searchEl, rootEl) {
     ...
     * @param rootEl: TYPE HTMLElement or String or 为空，本组件的基础组件，即属性data-ftc-component为ftc-header的元素
		 * 	TYPE HTMLElement, 即其上级的[data-ftc-component]="ftc-header"的元素
    ...
    */
      ...
      if (!searchEl) {
        searchEl = rootEl.querySelector('[data-ftc-component="ftc-header-search"]');
      } else if (!(searchEl instanceof HTMLElement)) {
        searchEl = rootEl.querySelector(searchEl);
      }
